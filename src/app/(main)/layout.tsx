		...
		<SessionProvider value={session}>
			<div className='flex min-h-dvh flex-col'>
				...
				<main className='max-w-7xl mx-auto p-5 flex w-full grow gap-5'>
					<MenuBar className='sticky top-[5.25rem] h-fit hidden sm:block flex-none space-y-3 rounded-2xl bg-primary-foreground px-3 py-5 lg:px-5 shadow-md border dark:border-none xl:w-80' />
					{children}
				</main>
